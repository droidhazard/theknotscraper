...
let selectedLocation = "dallas-tx";
let selectedCategory = "favors";
    ...
    while (hasMoreVendors) {
      ...
      for (const link of links) {
        try {
          ...
          console.log(`Searching for email addresses on vendor page: ${link}`);
          ...
          const uniqueEmailAddresses = [...new Set(emailsFound)];
